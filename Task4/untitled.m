...
% Last Modified by GUIDE v2.5 30-Oct-2017 10:32:17
...
function txtOpenImage1_Callback(hObject, eventdata, handles)
% hObject    handle to txtOpenImage1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of txtOpenImage1 as text
%        str2double(get(hObject,'String')) returns contents of txtOpenImage1 as a double


% --- Executes during object creation, after setting all properties.
function txtOpenImage1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to txtOpenImage1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ImageName = get(handles.txtOpenImage1 , 'string')
handles.Image = imread(char(ImageName));
% Set current drawing axes to "axes1"
axes(handles.axes2);
% Display the image
...
img1 = getimage (handles.axes2);
axes(handles.axes3);
[handles.Image, xTrans, yTrans]= FixTrans( img,img1 );
imshow(handles.Image);
figure,imshow(handles.Image);
set(handles.txtCol ,'string',xTrans);
set(handles.txtRow ,'string',yTrans);
...
img = getimage (handles.axes1);
img1 = getimage (handles.axes3);

ans = correct (img , img1);
set(handles.txtCorrect ,'string',ans);
